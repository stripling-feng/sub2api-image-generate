...
CROSS JOIN (VALUES
    ('omni-fast', 'Omni Fast', 5,
     '{"protocol":"omni-fast","images":5,"videos":0,"audios":0,"frameInputs":true,"maxImageBytes":5242880}', 6),
    ('omni-fast-no-water', 'Omni Fast No Watermark', 5,
     '{"protocol":"omni-fast","images":5,"videos":0,"audios":0,"frameInputs":true,"maxImageBytes":5242880}', 7),
    ('omni-v2v', 'Omni V2V', 2,
     '{"protocol":"omni-v2v","images":2,"videos":2,"audios":0,"frameInputs":false,"requiresVideo":true,"maxImageBytes":8388608,"maxVideoBytes":8388608}', 8),
    ('omni-v2v-no-water', 'Omni V2V No Watermark', 2,
     '{"protocol":"omni-v2v","images":2,"videos":2,"audios":0,"frameInputs":false,"requiresVideo":true,"maxImageBytes":8388608,"maxVideoBytes":8388608}', 9)
) AS seed(model_key, display_name, max_images, default_params, model_sort)
