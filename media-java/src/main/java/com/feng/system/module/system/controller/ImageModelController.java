...
public class ImageModelController {
    ...
    public ApiResponse<Void> saveImage(@RequestBody AiModel model) {
        service.saveImage(model);
        return ApiResponse.success(null);
    }

    @PutMapping("/api/model/images/{id}")
    public ApiResponse<Void> updateImage(@PathVariable Long id, @RequestBody AiModel model) {
        service.updateImage(id, model);
        return ApiResponse.success(null);
    }
