...
function capabilities(key) {
  if (key.startsWith('omni-v2v')) return ['文生 / 图生 / 视频参考', '最多 2 视频 / 2 图', '10 秒', '720p', key.endsWith('no-water') ? '无水印' : '标准水印']
  if (key.startsWith('omni-fast')) return ['文生 / 1–5 图', '首帧 / 尾帧', '10 秒', '720p', key.endsWith('no-water') ? '无水印' : '标准水印']
